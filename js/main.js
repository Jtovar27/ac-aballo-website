const translations = {
  es: {
    ...
    'book.payment.account.label': 'Número Zelle',
    'book.payment.name.label': 'Nombre en Zelle',
    'book.payment.body': 'Una vez agendada tu sesión, realiza el pago por Zelle al número indicado y envía el comprobante por mensaje de texto o Instagram @ac.aballo para confirmar tu lugar.',
    ...
    'policies.payment.body': 'Los pagos se realizan exclusivamente a través de Zelle al número (689) 339-6132 a nombre de AC.aballo. Se requiere el envío del comprobante de pago para confirmar la reserva y asegurar el cupo.',
    'policies.validity.label': 'Vigencia',
    'policies.validity.heading': 'Vigencia del Registro — 6 Meses',
    'policies.validity.body': 'La registración se realiza una sola vez y tiene vigencia de 6 meses a partir de la fecha de inscripción. Una vez vencido este período, será necesario renovar el registro para continuar participando en los programas de AC.aballo.',
    ...
    'faq.2.a': 'Los pagos se realizan exclusivamente por Zelle al número (689) 339-6132 a nombre de AC.aballo. Una vez realizado el pago, envía el comprobante por mensaje de texto o Instagram para confirmar tu reserva.',
  ...
  en: {
    ...
    'book.payment.account.label': 'Zelle number',
    'book.payment.name.label': 'Zelle name',
    'book.payment.body': 'Once your session is scheduled, send payment via Zelle to the number below and submit your receipt by text or Instagram @ac.aballo to confirm your spot.',
    ...
    'policies.payment.body': 'Payments are accepted exclusively via Zelle to (689) 339-6132 under the name AC.aballo. Proof of payment must be submitted to confirm your booking and secure your spot.',
    'policies.validity.label': 'Validity',
    'policies.validity.heading': 'Registration Validity — 6 Months',
    'policies.validity.body': 'Registration is a one-time process and remains valid for 6 months from the enrollment date. After this period expires, renewal is required to continue participating in AC.aballo programs.',
    ...
    'faq.2.a': 'Payments are made exclusively via Zelle to (689) 339-6132 under the name AC.aballo. Once payment is complete, send your receipt by text or Instagram to confirm your booking.',
