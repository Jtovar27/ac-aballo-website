const translations = {
  es: {
    ...
    'book.payment.body': 'Una vez agendada tu sesión, realiza el pago por Zelle al correo indicado y envía el comprobante por Instagram @ac.aballo para confirmar tu lugar.',
    ...
    'book.zelle.step3.body': 'Toma una captura del pago y envíala por Instagram @ac.aballo.',
  ...
  en: {
    ...
    'book.payment.body': 'Once your session is scheduled, send payment via Zelle to the email below and submit your receipt via Instagram @ac.aballo to confirm your spot.',
    ...
    'book.zelle.step3.body': 'Take a screenshot of the payment and send it via Instagram @ac.aballo.',
