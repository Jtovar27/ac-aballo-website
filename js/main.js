const translations = {
  es: {
    ...
    'hero.tagline': 'Escuela Ecuestre · Horsemanship · Conexión · Bienestar · Guía',
    ...
    'philosophy.founders': 'Los Fundadores',
    'philosophy.alvaro.role': 'Horseman · Doma Racional · Coaching con Caballos',
    'philosophy.alvaro.detail': '+45 años de experiencia · +600 potros domados',
    'philosophy.alvaro.quote1': '"Tomar las riendas, cambiará tu vida."',
    'philosophy.alvaro.quote2': '"Como doma racional, no es dominarlos, es entenderlos."',
    'philosophy.luisana.role': 'Cofundadora · Guía Emocional · Educación y Conexión',
    'philosophy.luisana.detail': 'Niños · Familias · Desarrollo emocional',
    'philosophy.luisana.quote': '"El caballo saca la mejor versión de quien está dispuesto a escucharse."',

    // About
    'about.label': 'Quiénes Somos',
    'about.heading': 'Una Escuela con Alma',
    'about.body1': 'AC.aballo nació en noviembre de 2020 en Florida como un proyecto familiar impulsado por el amor a los caballos y la convicción de que el vínculo entre el ser humano y el caballo tiene el poder de transformar vidas.',
    'about.body2': 'Abrimos nuestras puertas a todos: bebés desde los 11 meses, niños, adolescentes, adultos y familias completas. También acompañamos a personas con condiciones especiales con sesiones personalizadas y un enfoque de respeto y consciencia.',
    ...
    'services.horsemanship.title': 'Horsemanship y Doma Racional',
    ...
    'contact.form.service.opt2': 'Horsemanship y Doma Racional',
    ...
    'footer.hours.short': 'Lun–Sáb: 9am – 6pm · Dom: eventos previa planificación',
    ...
    // Book page
    'book.label': 'Reserva y Pago',
    'book.heading': 'Reserva tu Sesión',
    'book.subtitle': 'Selecciona tu programa, elige tu fecha y completa el pago por Zelle.',
    'book.steps.label': 'Cómo funciona',
    'book.steps.heading': 'Proceso de Reserva',
    'book.step1.title': 'Selecciona tu programa',
    'book.step1.body': 'Elige el programa que mejor se adapta a tus necesidades.',
    'book.step2.title': 'Agenda tu sesión',
    'book.step2.body': 'Escoge la fecha y horario de tu preferencia en el calendario.',
    'book.step3.title': 'Paga por Zelle',
    'book.step3.body': 'Realiza el pago y envía el comprobante para confirmar tu cupo.',
    'book.step4.title': 'Confirmación',
    'book.step4.body': 'Recibirás confirmación una vez verificado el pago.',
    'book.calendly.label': 'Agenda tu cita',
    'book.calendly.heading': 'Selecciona tu fecha y horario',
    'book.payment.label': 'Método de pago',
    'book.payment.heading': 'Pago por Zelle',
    'book.payment.account.label': 'Correo Zelle',
    'book.payment.name.label': 'Nombre en Zelle',
    'book.payment.body': 'Una vez agendada tu sesión, realiza el pago por Zelle al correo indicado y envía el comprobante al (689) 339-6132 por mensaje de texto o WhatsApp para confirmar tu lugar.',
    'book.payment.receipt': 'Envía tu comprobante a:',
    'book.zelle.step1.title': 'Agenda tu sesión en el calendario',
    'book.zelle.step1.body': 'Usa el calendario para elegir la fecha y horario que prefieras.',
    'book.zelle.step2.title': 'Envía el pago por Zelle',
    'book.zelle.step2.body': 'Transfiere el monto a AC.aballofl@gmail.com a nombre de AC.aballo.',
    'book.zelle.step3.title': 'Envía el comprobante',
    'book.zelle.step3.body': 'Toma una captura del pago y envíala al (689) 339-6132 por mensaje de texto o WhatsApp.',
    'book.zelle.step4.title': 'Recibe confirmación',
    'book.zelle.step4.body': 'Una vez verificado el pago, recibirás confirmación de tu sesión.',
    'book.policy.label': 'Políticas importantes',
    'book.policy.heading': 'Antes de reservar',
    'book.policy.cancel': 'Cancelación con hasta 24 horas de anticipación.',
    'book.policy.reschedule': 'Reprogramación usando el mismo pago ya realizado.',
    'book.policy.noshow': 'Cargo de $20 por inasistencia sin aviso previo.',
    'book.policy.validity': 'Registro válido por 6 meses desde la inscripción.',
    'book.policy.link': 'Ver políticas completas',

    // Policies page
    'policies.label': 'Políticas',
    'policies.heading': 'Nuestras Políticas',
    'policies.subtitle': 'Claridad y transparencia para una experiencia de calidad.',
    'policies.intro': 'En AC.aballo valoramos la claridad en cada aspecto de nuestra relación con los clientes. A continuación encontrarás nuestras políticas de manera concisa y transparente.',
    'policies.cancel.label': 'Cancelación',
    'policies.cancel.heading': 'Política de Cancelación',
    'policies.cancel.body': 'Los clientes pueden cancelar una clase con hasta 24 horas de anticipación sin penalidad. Las cancelaciones realizadas con menos de 24 horas de anticipación no son elegibles para reembolso ni reprogramación automática.',
    'policies.reschedule.label': 'Reprogramación',
    'policies.reschedule.heading': 'Política de Reprogramación',
    'policies.reschedule.body': 'Una clase puede reprogramarse utilizando el mismo pago ya realizado, siempre que la solicitud se haga con al menos 24 horas de anticipación. La reprogramación está sujeta a disponibilidad de horario.',
    'policies.noshow.label': 'Inasistencia',
    'policies.noshow.heading': 'Cargo por No Show — $20',
    'policies.noshow.body': 'Una vez que el cliente está registrado oficialmente y ha pagado el paquete del programa completo, si no asiste a una clase sin previo aviso ni justificación, se aplicará un cargo de $20 por inasistencia. Este cargo deberá abonarse antes de la siguiente sesión.',
    'policies.payment.label': 'Pago',
    'policies.payment.heading': 'Método de Pago — Zelle',
    'policies.payment.body': 'Los pagos se realizan exclusivamente a través de Zelle al correo AC.aballofl@gmail.com a nombre de AC.aballo. Se requiere el envío del comprobante de pago para confirmar la reserva y asegurar el cupo.',
    ...
    'faq.heading': 'FAQ',
    'faq.subtitle': 'Respuestas claras sobre nuestros programas, reservas y políticas.',
    'faq.1.q': '¿Cómo reservo una clase?',
    'faq.1.a': 'Visita nuestra página de Reservas, selecciona la fecha y horario de tu preferencia en el calendario, y completa el pago por Zelle para confirmar tu cupo.',
    'faq.2.q': '¿Cómo realizo el pago?',
    'faq.2.a': 'Los pagos se realizan exclusivamente por Zelle al correo AC.aballofl@gmail.com a nombre de AC.aballo. Una vez realizado el pago, envía el comprobante por Instagram @ac.aballo para confirmar tu reserva.',
    'faq.3.q': '¿Puedo cancelar mi clase?',
    'faq.3.a': 'Sí. Los clientes pueden cancelar con hasta 24 horas de anticipación sin penalidad. Las cancelaciones con menos de 24 horas de anticipación no son elegibles para reembolso.',
    'faq.4.q': '¿Puedo reprogramar mi clase?',
    'faq.4.a': 'Sí. Puedes reprogramar tu clase utilizando el mismo pago ya realizado, siempre que lo solicites con al menos 24 horas de anticipación. La reprogramación está sujeta a disponibilidad.',
    'faq.5.q': '¿Qué pasa si no asisto a una clase?',
    'faq.5.a': 'Si estás registrado y has pagado el paquete completo, una inasistencia sin previo aviso generará un cargo de $20. Comunícate con nosotros con al menos 24 horas de anticipación si no puedes asistir.',
    'faq.6.q': '¿Por cuánto tiempo es válida mi registración?',
    'faq.6.a': 'La registración es un proceso único con vigencia de 6 meses desde la fecha de inscripción. Al vencer este período, deberás renovar tu registro para continuar participando.',
    'faq.7.q': '¿Desde qué edad pueden participar los niños?',
    'faq.7.a': 'Aceptamos bebés desde los 11 meses para interacciones con caballos y desde los 4 años para clases regulares de equitación. También tenemos programas para familias y adultos de todas las edades.',
    'faq.8.q': '¿Tienen programas para personas con condiciones especiales?',
    'faq.8.a': 'Sí. Contamos con sesiones personalizadas para niños y adultos con autismo, TDA/TDAH y condiciones sensoriales. Coordinamos con padres y terapeutas cuando es necesario.',
    ...
    'pricing.visit.ages': 'Aplica para todas las edades',
  ...
  en: {
    ...
    'philosophy.founders': 'The Founders',
    'philosophy.alvaro.role': 'Horseman · Rational Horsemanship · Coaching with Horses',
    'philosophy.alvaro.detail': '+45 years of experience · +600 horses trained',
    'philosophy.alvaro.quote1': '"Taking the reins will change your life."',
    'philosophy.alvaro.quote2': '"Rational horsemanship is not about dominating them — it\'s about understanding them."',
    'philosophy.luisana.role': 'Co-founder · Emotional Guide · Education and Connection',
    'philosophy.luisana.detail': 'Children · Families · Emotional Development',
    'philosophy.luisana.quote': '"The horse brings out the best version of those willing to listen to themselves."',

    // About
    'about.label': 'Who We Are',
    'about.heading': 'A School with Soul',
    'about.body1': 'AC.aballo was born in November 2020 in Florida as a family project driven by love for horses and the conviction that the bond between human and horse has the power to transform lives.',
    'about.body2': 'We open our doors to everyone: babies from 11 months, children, teenagers, adults, and entire families. We also work with individuals with special conditions — with personalized sessions and a respectful, conscious approach.',
    ...
    'services.equitacion.tag2': 'Individual and group',
    'services.equitacion.tag3': '45 min',
    'services.equitacion.btn': 'Book',

    'services.horsemanship.title': 'Horsemanship and Rational Training',
    ...
    'contact.form.service.opt2': 'Horsemanship and Rational Training',
    'contact.form.service.opt3': 'Horse Interactions',
    'contact.form.service.opt4': 'Programs for Children and People with Special Conditions',
    'contact.form.service.opt5': 'Trail Rides',
    'contact.form.service.opt6': 'Events and Special Experiences',
    ...
    'footer.hours.short': 'Mon–Sat: 9am – 6pm · Sun: events by prior arrangement',
    ...
    // Book page
    'book.label': 'Book & Pay',
    'book.heading': 'Book Your Session',
    'book.subtitle': 'Select your program, choose your date, and complete payment via Zelle.',
    'book.steps.label': 'How it works',
    'book.steps.heading': 'Booking Process',
    'book.step1.title': 'Select your program',
    'book.step1.body': 'Choose the program that best fits your needs.',
    'book.step2.title': 'Schedule your session',
    'book.step2.body': 'Pick your preferred date and time using the calendar below.',
    'book.step3.title': 'Pay via Zelle',
    'book.step3.body': 'Send payment and your receipt to confirm your spot.',
    'book.step4.title': 'Confirmation',
    'book.step4.body': 'You will receive confirmation once payment is verified.',
    'book.calendly.label': 'Schedule your session',
    'book.calendly.heading': 'Select date and time',
    'book.payment.label': 'Payment method',
    'book.payment.heading': 'Payment via Zelle',
    'book.payment.account.label': 'Zelle email',
    'book.payment.name.label': 'Zelle name',
    'book.payment.body': 'Once your session is scheduled, send payment via Zelle to the email below and submit your receipt to (689) 339-6132 via text message or WhatsApp to confirm your spot.',
    'book.payment.receipt': 'Send your receipt to:',
    'book.zelle.step1.title': 'Schedule your session',
    'book.zelle.step1.body': 'Use the calendar above to choose your preferred date and time.',
    'book.zelle.step2.title': 'Send payment via Zelle',
    'book.zelle.step2.body': 'Transfer the amount to AC.aballofl@gmail.com under the name AC.aballo.',
    'book.zelle.step3.title': 'Send your receipt',
    'book.zelle.step3.body': 'Take a screenshot of the payment and send it to (689) 339-6132 via text message or WhatsApp.',
    'book.zelle.step4.title': 'Receive confirmation',
    'book.zelle.step4.body': 'Once payment is verified, you will receive confirmation of your session.',
    'book.policy.label': 'Key policies',
    'book.policy.heading': 'Before you book',
    'book.policy.cancel': 'Cancel up to 24 hours in advance.',
    'book.policy.reschedule': 'Reschedule using the same payment already made.',
    'book.policy.noshow': '$20 no-show fee for unannounced absences.',
    'book.policy.validity': 'Registration valid for 6 months from enrollment.',
    'book.policy.link': 'View full policies',

    // Policies page
    'policies.label': 'Policies',
    'policies.heading': 'Our Policies',
    'policies.subtitle': 'Clarity and transparency for a quality experience.',
    'policies.intro': 'At AC.aballo we value clarity in every aspect of our relationship with clients. Below you will find our policies in a concise and transparent manner.',
    'policies.cancel.label': 'Cancellation',
    'policies.cancel.heading': 'Cancellation Policy',
    'policies.cancel.body': 'Clients may cancel a class up to 24 hours in advance without penalty. Cancellations made with less than 24 hours notice are not eligible for a refund or automatic rescheduling.',
    'policies.reschedule.label': 'Rescheduling',
    'policies.reschedule.heading': 'Rescheduling Policy',
    'policies.reschedule.body': 'A class may be rescheduled using the same payment already made, provided the request is made at least 24 hours in advance. Rescheduling is subject to availability.',
    'policies.noshow.label': 'No-Show',
    'policies.noshow.heading': 'No-Show Fee — $20',
    'policies.noshow.body': 'Once a client is officially registered and has fully paid for the program package, failure to attend a class without prior notice or explanation will result in a $20 no-show fee. This fee must be paid before the next session.',
    'policies.payment.label': 'Payment',
    'policies.payment.heading': 'Payment Method — Zelle',
    'policies.payment.body': 'Payments are accepted exclusively via Zelle to AC.aballofl@gmail.com under the name AC.aballo. Proof of payment must be submitted to confirm your booking and secure your spot.',
    ...
    'faq.heading': 'FAQ',
    'faq.subtitle': 'Clear answers to the most common questions about our programs, bookings, and policies.',
    'faq.1.q': 'How do I book a class?',
    'faq.1.a': 'Visit our Book page, select your preferred date and time from the calendar, and complete payment via Zelle to confirm your spot.',
    'faq.2.q': 'How do I pay?',
    'faq.2.a': 'Payments are made exclusively via Zelle to AC.aballofl@gmail.com under the name AC.aballo. Once payment is complete, send your receipt via Instagram @ac.aballo to confirm your booking.',
    'faq.3.q': 'Can I cancel my class?',
    'faq.3.a': 'Yes. Clients may cancel up to 24 hours in advance without penalty. Cancellations with less than 24 hours notice are not eligible for a refund.',
    'faq.4.q': 'Can I reschedule my class?',
    'faq.4.a': 'Yes. You may reschedule your class using the same payment already made, provided you request it at least 24 hours in advance. Rescheduling is subject to availability.',
    'faq.5.q': 'What happens if I miss a class?',
    'faq.5.a': 'If you are registered and have fully paid for the program package, an unannounced absence results in a $20 no-show fee. Please notify us at least 24 hours in advance if you cannot attend.',
    'faq.6.q': 'How long is my registration valid?',
    'faq.6.a': 'Registration is a one-time process valid for 6 months from the enrollment date. After this period, you will need to renew your registration to continue participating.',
    'faq.7.q': 'From what age can children participate?',
    'faq.7.a': 'We welcome babies from 11 months for horse interactions and children from age 4 for regular riding classes. We also have programs for families and adults of all ages.',
    'faq.8.q': 'Do you have programs for people with special conditions?',
    'faq.8.a': 'Yes. We offer personalized sessions for children and adults with autism, ADD/ADHD, and sensory conditions. We coordinate with parents and therapists when needed.',
    ...
    'pricing.visit.ages': 'Applies to all ages',
  ...
  contactForm.addEventListener('submit', function (e) {
    ...
    fetch('https://api.web3forms.com/submit', {
      ...
      .finally(function () {
        ...
        if (btnSpan) {
          btnSpan.textContent = translations[localStorage.getItem('lang') || 'es']['contact.form.submit'];
        }
      });
  });
}
...
function setupLangToggle(btnId, labelId) {
  ...
  btn.addEventListener('click', function () {
    ...
    var otherLabel = document.getElementById(
      btnId === 'lang-toggle' ? 'lang-label-mobile' : 'lang-label'
    );

    if (otherLabel) {
      otherLabel.textContent = next === 'es' ? 'EN' : 'ES';
    }
  });
}
